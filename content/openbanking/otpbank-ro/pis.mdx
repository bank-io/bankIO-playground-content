---
templateKey: docs
title: "OTP Bank Payment Service (PIS)"
metaTitle: "OTP Bank Payment Service (PIS)"
metaDescription: "API playground for OTP Bank Payment Service (PIS)"
...
import otbBankPISPRequestOverride from './pisp-consent-override.json'
  ...
  <StepInitiatePayment requestOverride={otbBankPISPRequestOverride} />
  </step>
  <step>
