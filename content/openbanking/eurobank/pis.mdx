---
templateKey: docs
title: "Eurobank Bank Payment Service (PIS)"
metaTitle: "Eurobank Bank Payment Service (PIS)"
metaDescription: "API playground for Eurobank Bank Payment Service (PIS)"
...
import eurobankScenarios from './scenarios.json';
import eurobankPISPRequestOverride from './pisp-consent-override.json'
  ...
  <StepInitiatePayment requestOverride={eurobankPISPRequestOverride} />
  </step>
<step>
