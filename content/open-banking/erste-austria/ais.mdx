...
import ersteAustriaAISPRequestOverride from './aisp-consent-override.json'
...
<step>
  ...
  <StepCreateAccountConsent requestOverride={ersteAustriaAISPRequestOverride} />
  </step>
  <step>
